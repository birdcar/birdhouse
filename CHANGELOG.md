...
- Verify that auto binary publishing works with OIDC Trusted Publishing configured on npm
- [ ] Merge PR and verify publish job succeeds with OIDC authentication
